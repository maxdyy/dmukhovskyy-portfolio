  ...
  render() {
    ...
    return (
      <li className="project-item">
        <div className={`collapsible-header header-${id}`} style={projectStyle.gradient}>
          <div className={`project-icon icon-${id}`} style={projectStyle.icon} />
        ...
        <div className="collapsible-body">
          ...
          <div className="project-desc"><span>{projectDescription}</span></div>
