  ...
  _createClass(Blog, [{
    ...
    value: function componentDidMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_2_axios___default()({
        ...
        self.setState({
          blogTitle: result.data.data.blogPost.postTitle
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      }, this.state.blogTitle), "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.", " ");
    }
  }]);
...
//# sourceMappingURL=4.f4129526de4cbaffe04d.hot-update.js.map